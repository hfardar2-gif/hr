...
export default async function DepartmentPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <DashboardShell role="executive"><div className="dashboard-page-stack">
    ...
    <SectionHeading title="مقایسه با سایر واحدها" description="برای مشاهده جزئیات هر واحد از جدول داشبورد اصلی استفاده کنید" action="بازگشت به داشبورد" href="/executive" />
  </div></DashboardShell>;
}
