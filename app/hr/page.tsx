...
export default function HrDashboard() {
  return <DashboardShell role="hr">
    ...
    <section><SectionHeading title="تحلیل واحدهای سازمانی" description="از وضعیت کل سازمان به واحد و سپس پرونده فردی وارد شوید" action="گزارش رفتار سازمانی" href="/hr/organizational-behavior" /><Card className="table-card"><CardContent className="p-0"><DepartmentTable hr /></CardContent></Card></section>
